...
export interface PaperNavigationProps {
...
const defaultPaperNavigationProps: PaperNavigationProps = {
  enableAvatar: false,
  avatar: {
    src: "",
    active: false,
...
export const PaperNavigation = React.memo(
  (props: PaperNavigationProps = defaultPaperNavigationProps) => {
