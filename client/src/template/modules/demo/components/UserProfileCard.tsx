...
import { Avatar, Box, Card, CardContent, CardHeader, List, ListItem } from "@material-ui/core";
...
export const UserProfileCard = React.memo<IProps>(({ user, triggerSlot, loading }) => {
