...
export const PaperButton = React.memo((props: PaperButtonProps = defaultPaperButtonProps) => {
  const classes = useStyles();
  const Icon = props.icon;

  return (
      <div className={classes.btnWrapper}>
        <ButtonBase focusRipple className={classes.btn} focusVisibleClassName={classes.btnFocusVisible} disabled={props.loading}>
