...
export interface PaperIStyleProps {
  bg?: string;
}

const useStyle = makeStyles<Theme, PaperIStyleProps>((theme) =>
  createStyles({
    paperWrapper: {
      height: "100vh",
      width: "100vw",
...
const defaultPaperIProps: PaperIProps = {
  enableAvatar: false,
  nav: <div/>,
  content: <div/>,
  bg: Bg1,
...
export const PaperI = React.memo<PaperIProps>((props: PaperIProps = defaultPaperIProps) => {
